    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="title-div margin-20">
                ...
                <h2 class="title">Aggiungi movimento</h2>
            </div>
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg margin-20" style="padding: 20px;">
                <form method="POST" action="/aggiungi" class="center">
                    @csrf
                    <div class="add_card margin-20">
                        <label for="name">Nome</label>
                        <input type="text" id="name" name="name" required placeholder="Nome movimento"/>
                    </div>
                    <div class="add_card margin-20">
