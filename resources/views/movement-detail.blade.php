    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg margin-20" style="padding: 20px;">
                <div style="">
                    <form method="POST" action="/transaction/detail/{{$movement->id}}" class="center">
                        @csrf
                        <div class="add_card margin-20">
                            <label for="name">Name</label>
                            <input type="text" id="name" name="name" required placeholder="Name" value="{{ $movement->name }}"/>
                        </div>
                        <div class="add_card margin-20">
                        ...
                        <div class="add_card margin-20">
                            ...
                            <select name="type" id="type" onchange="getNewCategories(this)">
                                @if ($movement->movement_type_id == 1)
                                    <option value="1" selected>Expenses</option>
                                    <option value="2">Earnings</option>
                                @else
                                    <option value="1">Expenses</option>
                                    <option value="2" selected>Earnings</option>
                                @endif
                              </select>
                        </div>
                        <div class="add_card margin-20">
                        ...
                        <div class="margin-20" style="display: flex; justify-content:center; gap:30px;">
                            <div style="text-align: center">
                                <input type="submit" name="action"  value="Delete" class="button btn-del">
                            </div>
                            <div style="text-align: center">
                                <input type="submit" value="Save" class="button btn-save" name="action" >
                            </div>
                        </div>
